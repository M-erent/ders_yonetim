...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    header("Location: Yonetici_Panel.php?tab=attendances&msg=Yoklama güncellendi");
    exit();
}

// Mevcut yoklama verisini çek
$stmt = $db->prepare("SELECT * FROM attendances WHERE id = ?");
$stmt->execute([$id]);
$row = $stmt->fetch(PDO::FETCH_ASSOC);
if (!$row) {
    die("Yoklama bulunamadı!");
}
...
<head>
  ...
  <title>Yoklama Düzenle - Yönetici Paneli</title>
  <link
    rel="stylesheet"
  ...
  <div class="edit-container">
    ...
    <div class="edit-form">
        ...
        <div class="form-group">
          ...
          <div class="input-icon">
            ...
            <input
              ...
              class="form-control"
              value="<?= htmlspecialchars($row['attendance_date']) ?>"
              required
            />
          </div>
        </div>
      ...
      <div class="back-button">
        <a href="Yonetici_Panel.php?tab=attendances">
