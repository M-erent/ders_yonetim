...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    header("Location: Yonetici_Panel.php?tab=courses&msg=Ders güncellendi");
    exit();
}

// Mevcut ders verisini çek
...
<head>
  ...
  <title>Ders Düzenle - Yönetici Paneli</title>
  <link
    rel="stylesheet"
  ...
  <div class="edit-container">
    ...
    <div class="edit-form">
      ...
      <div class="back-button">
        <a href="Yonetici_Panel.php?tab=courses">
